...
// bridge + the fictional municipal IT landscape (Musterstadt) — inlined by Vite (?raw) and
// loaded into one in-browser store. That composition is the join the project is about;
// shared by every page that queries it (the Query page and the use-case pages).
...
export const graphStore = () => storeFromTurtles([dstackTtl, leistungenTtl, fimTtl, fitConnectTtl, bridgeTtl, musterstadtTtl, chatbotTtl])
